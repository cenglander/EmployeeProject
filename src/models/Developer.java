...
public class Developer extends Employee {
    ...
    public void printExtraInfo() {
        System.out.println("                Programming language: " + programmingLanguage + "   Developer level: " + developerLevel.toString().charAt(0) + developerLevel.toString().substring(1).toLowerCase());
    }
