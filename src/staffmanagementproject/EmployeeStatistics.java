...
public class EmployeeStatistics {
    ...
    public static void allSalaries() {
        ...
        for (Employee currentEmployee : sortedList) {
            ...
            System.out.println(fixLength(Integer.toString(currentEmployee.getID()), 6) + fixLength(nameSplit[0], 10) + fixLength(nameSplit[1], 15) + String.format("%,.2f", currentEmployee.getSalary()));
        }
    }
