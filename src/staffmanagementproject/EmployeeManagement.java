...
public class EmployeeManagement {
    ...
    public static void removeEmployeeById() {
        ...
        for (int i = 0; i < employeeList.size(); i++) {
            if (employeeList.get(i).getID() == ID) {
                System.out.println("\nEmployee " + employeeList.get(i).getName() + " has been removed");
    ...
    public static void removeEmployeeByName() {
        ...
        for (int i = 0; i < employeeList.size(); i++) {
            if (employeeList.get(i).getName().equalsIgnoreCase(name)) {
                System.out.println("\nEmployee with ID " + employeeList.get(i).getID() + " has been removed");
                employeeList.remove(i);
                return;
            }
        }
    ...
    public static void updateDeveloperLevel(Employee employee) {
        System.out.print("Enter new Developer level (junior/senior): ");
    ...
    public static void updateWebsites(Employee employee) {
        ...
        System.out.println("Write websites to add or (if existing) to remove them (Enter 0 to Exit)");
    ...
    public static void loadDb() {
        ...
        WebDesigner webdesigner1 = new WebDesigner(23500, "Kalle Svensson", "2001-04-03", GenderType.MALE);
